...
<aside class="sidebar" id="sidebar">
    ...
    <a href="../pages/adminreport.php?view=all" class="icon_container">
        <img src="../assets/images/admin.png" class="sidebar_icon">
        <span class="icon_text">Admin Reports</span>
    </a>
    ...
    <a href="../pages/userprofile.php" class="icon_container">
        <img src="../assets/images/report.png" class="sidebar_icon">
        <span class="icon_text">User Reports</span>
    </a>
